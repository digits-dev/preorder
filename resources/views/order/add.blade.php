...
@section('content')
    ...
    <div class='panel panel-default'>
        <div class='panel-heading'>
            <h3 class="box-title text-center"><b>Reservation</b></h3>
        </div>
                                ...
                                <thead>
                                    <tr style="background: #0047ab; color: white">
                                        ...
                                        <th width="20%" class="text-center"
                                            ...
                                            {{ trans('label.table.amount') }}</th>
                                        <th width="10%" class="text-center"
                                            data-title="{{ trans('label.table.reservable_qty') }}">
                                            {{ trans('label.table.reservable_qty') }}</th>
                                        <th width="10%" class="text-center"
                                            data-title="{{ trans('label.table.action') }}">
                                            {{ trans('label.table.action') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr class="tableInfo">
                                        <td align="center"> <strong>{{ trans('label.table.total_skus') }} : <span
                                                    id="totalSKUS"></span></strong> </td>
                                        <td align="right"> <strong>{{ trans('label.table.total_quantity') }}</strong>
                                        </td>
                                        <td> <input type='number' name="total_quantity" class="form-control text-center"
                                                id="totalQuantity" value="0" readonly> </td>
                                        <td colspan="3"> </td>
                                    </tr>
                                </tbody>
                            </table>
