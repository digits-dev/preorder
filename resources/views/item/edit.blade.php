...
@endpush
    ...
    <div class='panel panel-default'>
        ...
        <h3 class="box-title text-center"><b>Item Update</b></h3>
        </div>
        {{-- {{ route('item.create') }} --}}
        <form action="{{CRUDBooster::mainpath('edit-save/'.$row->id)}}" method="POST" id="item" autocomplete="off" role="form" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="number" style="width:100%" name="digits_code" id="digits_code" value="{{ $row->digits_code }}" required>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 25%">
                                ...
                                <td>
                                    <input class="form-control" type="text" style="width:100%" name="upc_code" id="upc_code" value="{{ $row->upc_code }}" required>
                                </td>
                            </tr>
                                ...
                                <td>
                                    <select name='brands_id' id="brands_id" class='form-control' required>
                                        ...
                                        @foreach ($brands as $brand)
                                            <option {{ $row->brands_id == $brand->id ? "selected" : "" }} value={{ $brand->id }}>{{ $brand->brand_name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control" type="text" style="width:100%" name="item_description" id="item_description" value="{{ $row->item_description }}" required>
                                </td>
                            </tr>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                                ...
                                <td>
                                    <select name='item_models_id' id="item_models_id" class='form-control' required>
                                        ...
                                        @foreach ($models as $model)
                                            <option {{ $row->item_models_id == $model->id ? "selected" : "" }} value={{ $model->id }}>{{ $model->model_name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td colspan="2">
                                    <select name='sizes_id' id="sizes_id" class='form-control' required>
                                        ...
                                        @foreach ($sizes as $size)
                                            <option {{ $row->sizes_id == $size->id ? "selected" : "" }} value={{ $size->id }}>{{ $size->size }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                                ...
                                <td colspan="2">
                                    <select name='colors_id' id="colors_id" class='form-control' required>
                                        ...
                                        @foreach ($colors as $color)
                                            <option {{ $row->colors_id == $color->id ? "selected" : "" }} value={{ $color->id }}>{{ $color->color_name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="2">
                                    <input class="form-control" type="number" style="width:100%" name="current_srp" id="current_srp" value="{{ $row->current_srp }}" required>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                                ...
                                <td colspan="2">
                                    <select name='campaigns_id' id="campaigns_id" class='form-control' required>
                                        ...
                                        @foreach ($campaigns as $campaign)
                                            <option {{ $row->campaigns_id == $campaign->id ? "selected" : "" }} value={{ $campaign->id }}>{{ $campaign->campaigns_name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                                ...
                                <td colspan="2">
                                    <select name='included_freebies[]' id="included_freebies" style="width: 100%" class='form-control' multiple='multiple'>
                                        ...
                                        @foreach ($freebies as $set)
                                            <option {{  in_array($set->id,explode(",",$row->included_freebies)) ? "selected" : "" }} value={{ $set->id }}>{{ $set->category_name }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input class="form-control" type="number" style="width:100%" name="dtc_wh" id="dtc_wh" value="{{ $row->dtc_wh }}" required>
