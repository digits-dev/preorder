        ...
        <thead>
            <tr class="active">
                ...
                foreach ($columns as $col) {
                    ...
                    echo "<th class='mid-header' width='$width' $style>";
                ...
                @if ($button_table_action)
                    @if (CRUDBooster::isUpdate() || CRUDBooster::isDelete() || CRUDBooster::isRead())
                        <th width='{{ isset($button_action_width) ? $button_action_width : 'auto' }}'
                            class='mid-header'>{{ cbLang('action_label') }}</th>
                    @endif
                @endif
            </tr>
        </thead>
        ...
        <tfoot>
            <tr>
                ...
                foreach ($columns as $col) {
                    ...
                    $width = isset($col['width']) ? $col['width'] : 'auto';
                    $style = isset($col['style']) ? $col['style'] : '';
                    echo "<th class='mid-header' width='$width' $style>$colname</th>";
                }
                ?>

                @if ($button_table_action)
                    @if (CRUDBooster::isUpdate() || CRUDBooster::isDelete() || CRUDBooster::isRead())
                        <th class='mid-header'> -</th>
                    @endif
                @endif
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type='text' name='filename' class='form-control' required
                                    value='Export {{ CRUDBooster::getCurrentModule()->name }} - {{ date('Y-m-d H:i:s') }}' />
                            ...
                            <div class="form-group">
                                ...
                                <input type='number' name='limit' class='form-control' required value='100000'
                                    max="100000" min="1" />
                            ...
                            <div class="row" style="padding: 0 15px 0 15px;">
                                ...
                                @foreach ($columns as $keyCol => $col)
                                    @if ($keyCol + 1 < sizeof($columns) * (1 / 3))
                                    ...
                                    @elseif ($keyCol + 1 < sizeof($columns) * (2 / 3))
