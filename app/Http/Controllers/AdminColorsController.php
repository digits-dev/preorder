<?php namespace App\Http\Controllers;
	...
	class AdminColorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "color_name";
			$this->limit = "20";
			$this->orderby = "color_name,asc";
			...
			$this->col = [];
			$this->col[] = ["label"=>"Color Name","name"=>"color_name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Color Name','name'=>'color_name','type'=>'text','validation'=>'required|min:3|max:50','width'=>'col-sm-6'];
