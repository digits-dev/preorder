...
use Session;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Customer Name','name'=>'customer_name','type'=>'text','validation'=>'required|min:2|max:100','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Contact Number','name'=>'contact_number','type'=>'text','validation'=>'required|min:2|max:20','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Email Address','name'=>'email_address','type'=>'email','validation'=>'required|min:5|max:100|email|unique:customers','width'=>'col-sm-6','placeholder'=>'Please enter a valid email address'];
	    ...
	    */
		...
		{
			return json_encode(Customer::where('email_address',$request->email_address)->first());
		}
	}