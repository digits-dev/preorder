<?php namespace App\Http\Controllers;
	...
	class AdminPaymentMethodsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "payment_method";
			$this->limit = "20";
			$this->orderby = "payment_method,asc";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Payment Method','name'=>'payment_method','type'=>'text','validation'=>'required|min:3|max:100','width'=>'col-sm-6'];
