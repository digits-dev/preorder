<?php namespace App\Http\Controllers;
	...
	class AdminChannelsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Channel Code','name'=>'channel_code','type'=>'text','validation'=>'required|min:2|max:10','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Channel Name','name'=>'channel_name','type'=>'text','validation'=>'required|min:2|max:25','width'=>'col-sm-6'];
