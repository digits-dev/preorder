<?php namespace App\Http\Controllers;
	...
	class AdminStoresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Store Name','name'=>'store_name','type'=>'text','validation'=>'required|min:3|max:100','width'=>'col-sm-6'];
	    ...
	    */
		...
		public function storeUpload(Request $request)
		{
            ...
            foreach ($stores as $store) {
                ...
                if(!empty($storeDetails)){
                    array_push($errors, 'store '.$store.' already exists!');
                }
            }
		...
		public function storeTemplate()
		{
            ...
            return Excel::download($export, 'stores-'.date("Ymd").'-'.date("h.i.sa").'.csv');
		}
		...
		public function storeView()
		{
            ...
            $data = [];
            $data['page_title'] = 'Upload Stores';
            $data['uploadRoute'] = route('store.upload');
            $data['uploadTemplate'] = route('store.template');
