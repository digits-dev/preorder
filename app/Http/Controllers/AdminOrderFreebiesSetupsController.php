<?php namespace App\Http\Controllers;
	...
	class AdminOrderFreebiesSetupsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "order_freebies_setups";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"With Freebies","name"=>"with_freebies"];
			$this->col[] = ["label"=>"Max Freebies","name"=>"max_freebies"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'With Freebies','name'=>'with_freebies','type'=>'radio','validation'=>'required|integer|min:0','width'=>'col-sm-6','dataenum'=>'0|No;1|Yes'];
			$this->form[] = ['label'=>'Max Freebies','name'=>'max_freebies','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-6'];
