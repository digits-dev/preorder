<?php namespace App\Http\Controllers;
	...
	class AdminClaimStatusesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "claim_statuses";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Status Name","name"=>"status_name"];
			$this->col[] = ["label"=>"Status Style","name"=>"status_style"];
			...
			$this->form = [];
			$this->form = [];
			$this->form[] = ['label'=>'Status Name','name'=>'status_name','type'=>'text','validation'=>'required|min:3|max:100','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Status Style','name'=>'status_style','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-6'];
