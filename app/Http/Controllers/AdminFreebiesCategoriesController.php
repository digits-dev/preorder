<?php namespace App\Http\Controllers;
	...
	class AdminFreebiesCategoriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "freebies_categories";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Category Name","name"=>"category_name"];
			$this->col[] = ["label"=>"Background Color","name"=>"color_style"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Category Name','name'=>'category_name','type'=>'text','validation'=>'required|min:1|max:100','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Background Color','name'=>'color_style','type'=>'text','validation'=>'required|min:1|max:20','width'=>'col-sm-6'];
